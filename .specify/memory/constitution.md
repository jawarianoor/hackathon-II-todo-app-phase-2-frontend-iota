...
Bump rationale: MAJOR - Complete architectural transformation from CLI to full-stack web application

Modified principles:
- None (complete replacement for Phase II)

Added sections:
- Article I: Project Identity (Phase II specific)
- Article II: Core Functional Requirements (web-adapted)
- Article III: Authentication & Security Model (NEW)
- Article IV: REST API Contract (NEW)
- Article V: Technology Stack (Non-Negotiable)
...
Removed sections:
- Phase I specific constraints (in-memory, CLI-only)

Templates requiring updates:
- .specify/templates/plan-template.md: pending update for web structure
- .specify/templates/spec-template.md: pending update for API specs
- .specify/templates/tasks-template.md: pending update for frontend/backend phases
